...
| Verdict author | **your account** (PAT) | **`zeabur-council[bot]`** or your App bot |
...
For verdicts authored by a GitHub App bot instead of your account, and a webhook
trigger with no per-repo workflow file:
...
Step-by-step: [deploy.md](deploy.md) §2–§3 +
