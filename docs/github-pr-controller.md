...
| `GITHUB_CONTROLLER_DB` | `github-controller.db` | Controller-owned database: a `postgres://…` URL selects the Postgres backend (ADR 033), any other value is a SQLite path |
