...
| **Fleet provisioner** — recruiting a bot type that has no pod yet spins one up (Zeabur) | TODO | Separate trust domain → off the coordination hot path. Today recruit targets an already-registered bot. See ADR 001 |
